...
description: "useWeatherTheme toggles the 'dark' CSS class on the HTML element based on whether it is currently daytime at the selected location, enabling automatic light/dark theming."
---
